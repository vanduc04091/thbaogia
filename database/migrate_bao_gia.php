...
CREATE TABLE IF NOT EXISTS bg_hang_hoa (
    ...
    ma_hh VARCHAR(50) NULL COMMENT 'Mã HH (VD: VT001) — Phụ lục III Thư mời',
    ten_hang_hoa VARCHAR(1000) NOT NULL COMMENT 'Tên hàng hóa chào giá',
    thong_so_ky_thuat TEXT NULL COMMENT 'Yêu cầu kỹ thuật mời chào giá',
    dvt VARCHAR(50) NULL COMMENT 'Đơn vị tính',
    so_luong DECIMAL(18,3) DEFAULT 0 COMMENT 'Số lượng / khối lượng',
    thu_tu INT DEFAULT 0 COMMENT 'STT hiển thị',
    ngay_tao DATETIME DEFAULT CURRENT_TIMESTAMP,
    ngay_cap_nhat DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    nguoi_tao INT NULL,
    nguoi_cap_nhat INT NULL,
...
CREATE TABLE IF NOT EXISTS bg_bao_gia_chi_tiet (
    ...
    thong_so_chao_gia TEXT NULL COMMENT 'Yêu cầu kỹ thuật chào giá',
    diem_khong_dat TEXT NULL COMMENT 'Các điểm không đạt kèm thuyết minh',
    -- Mẫu 2: Bảng chào giá
    ten_thuong_mai VARCHAR(1000) NULL,
    model VARCHAR(500) NULL COMMENT 'Ký, mã, nhãn hiệu, model',
    hang_san_xuat VARCHAR(500) NULL,
    xuat_xu VARCHAR(500) NULL,
    quy_cach VARCHAR(500) NULL,
    don_gia DECIMAL(20,2) DEFAULT 0 COMMENT 'Đã gồm thuế, phí, lệ phí, dịch vụ',
    thanh_tien DECIMAL(20,2) DEFAULT 0 COMMENT 'don_gia * so_luong, tính ở server',
    don_gia_trung_thau DECIMAL(20,2) DEFAULT 0,
    tai_lieu_tham_chieu TEXT NULL COMMENT 'Mẫu 2 ghi chú (12) — số thông báo mời thầu, VD: IB2500...',
    ngay_tao DATETIME DEFAULT CURRENT_TIMESTAMP,
    ngay_cap_nhat DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    da_xoa INT DEFAULT 0,
